        ...
        <tbody>
          @foreach($Cities as $City)
            <tr>
              <td>{{ $City->name }}</td>
              <td>
                <a style="font-size: 20px;" class="action-btn edit-btn" href="{{ route('city.edit', [ $City['id']]) }}">
                  <span class="mdi mdi-pen"></span>
                </a>
                <a style="font-size: 20px;" class="action-btn single-btn" href="{{ route('city.show', [ $City['id']]) }}">
